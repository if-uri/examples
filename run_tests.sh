...
PY="$(pick_python)" || { echo "ERROR: no Python with 'urirun' found. Install: pip install 'git+https://github.com/tellmesh/urirun.git@v0.3.11#subdirectory=adapters/python'"; exit 2; }
