...
PY="$(pick_python)" || { echo "ERROR: no Python with 'urirun' found. Install: pip install \"git+\${URIRUN_REPO_URL:-https://github.com/if-uri/urirun.git}@\${URIRUN_REF:-main}#subdirectory=adapters/python\""; exit 2; }
